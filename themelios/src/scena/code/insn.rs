...
themelios_macros::bytecode! {
	...
	[
		...
		#[game(ZeroEvo)] ZE_E2(u32,u32,u32, u8, u32, u32),
		#[game(ZeroEvo)] ZE_E3(u8, String, u32, u32, u8),
		#[game(ZeroEvo)] ZE_E4(u8, u16),
		#[game(ZeroEvo)] ZE_E5(u8, u8, String, String, Pos3, Pos3, Pos3, u8),
		#[game(ZeroEvo)] ZE_E6(u8, u8, Pos3, Pos3, Pos3),
		#[game(ZeroEvo)] ZE_E7(u8, u8),
		#[game(ZeroEvo)] ZE_E8(u8),
		#[game(ZeroEvo)] ZE_E9(u16, u32,u32,u32,u32, u32,u32,u32,u32),
